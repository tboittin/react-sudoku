...
/**
 * a function that identifies and return the current square of a given sudoku grid at a row and a column index
 * @param input Object with 9x9 sudoku grid, row, index and column index
 * @returns the current square of a given sudoku grid at a row and a column index
 */
